...
<body>
  ...
  <h2>BUDGET FOR CATEGORIES</h2>
    <div class="columns">
  <ul class="price">
    <li class="header">breakfast/lunch/dinner</li>
    <li class="grey">1500/ month</li>
    <li>enter what u ate</li>
    <li>enter what u ate</li>
    <li>enter what u ate</li>
    <li>enter what u ate</li>
    <li class="grey"><a  class="button">UNDER BUDGET</a></li>
  </ul>
  </div>
  <div class="columns">
  <ul class="price">
    <li class="header" style="background-color:red">house rent</li>
    <li class="grey">5000 /month</li>
    <li>electricity:- </li>
    <li>room cleaning :-</li>
    <li>product maintenance :- </li>
    <li>wifi bill :- </li>
    <li class="grey"><a href="#" class="button">OVER BUDGET</a></li>
  </ul>
</div>
...
<div class="columns">
  <ul class="price">
    ...
    <li class="grey">4000 / month</li>
    <li>Utensils :- @</li>
    <li>Clothing :- @</li>
    <li>Grocery :- @</li>
    <li>Sanitary :- @</li>
    <li class="grey"><a href="#" class="button">Under Budget</a></li>
  </ul>
</div>
