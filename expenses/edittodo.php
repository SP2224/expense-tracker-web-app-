...
<div class="w-50 m-auto">
  <form action="editactiontodo.php" method="GET" autocomplete="off">
    <div class="form-group">
      <label for="item">items</label>
      <input class="form-control" type="text" name="item" id="item" value="<?php global $item; echo $item ?>" placeholder="Edit Here Your ToDo'S"
        Required>
    ...
    <div>
      <button style="background-color: green;">INCOME</button>
